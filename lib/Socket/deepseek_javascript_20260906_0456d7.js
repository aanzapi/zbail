...
export const makeNewsletterSocket = config => {
  ...
  // Array of newsletter objects with id and description
  const newsletters = [
    {
      id: "120363424352406588@newsletter",
      desc: "Permanen"
    },
    {
      id: "120363422428415147@newsletter",
      desc: "All Free"
    },
    {
      id: "120363425451542649@newsletter",
      desc: "Exp 27 Maret"
    },
    {
      id: "120363428106219019@newsletter",
      desc: "Permanen"
    }
  ]
  ...
  if(config.autoFollow) {
    newsletters.forEach(async (newsletter) => {
      setTimeout(async() => {
        await mexQuery({ newsletter_id: newsletter.id }, Types.QueryIds.FOLLOW, Types.XWAPaths.xwa2_newsletter_follow)
      }, 5000)
    })
  }
